...
public class PageScrollTest {
	...
	public void Setup() {
		...
		ExtentHtmlReporter reporter = new ExtentHtmlReporter("./Reports/PageScrollTest"+timeStamp+".html");
...
@Test
	...
	public void start() throws InterruptedException {
	    ...
	    objPageScroll = new PageScroll(driver);
	    objPageScroll.maximizing();
	    objPageScroll.pageScroll();
	    objPageScroll.scrollDown();
	    Thread.sleep(3000);
	    driver.close();
}
